...
basicConfig(format='[%(asctime)s - %(levelname)s] %(message)s',
            datefmt="%H:%M:%S")
logger = getLogger("Pegasus-Big-DDOS")
...
class ToolsConsole:
    ...
    @staticmethod
    def runConsole():
        cons = f"{gethostname()}@PegasusHacker:~#"
    ...
    def usage():
        print((
                  '* Pegasus Big DDOS is Script With %d Methods\n'
        ...
        with suppress(IndexError):
            ...
            if method in Methods.LAYER7_METHODS:
                ...
                if method == "BOMB":
                    assert (
                        ...
                        "Install bombardier: "
                        "https://github.com/sobri3195/pegasql.git"
                    )
            ...
            if method in Methods.LAYER4_METHODS:
                ...
                if method in Methods.LAYER4_AMP:
                    ...
                    logger.warning("https://github.com/sobri3195/pegabox.git")
